    ...
    <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center p-4">
        ...
        <Card className="bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 professional-shadow">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-neutral-600 dark:text-neutral-400">
              Join RiskProfiler to start analyzing your portfolio risk
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <AlertDialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <AlertDialogContent className="bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-green-600 dark:text-green-400">Account Created Successfully!</AlertDialogTitle>
